...
// Modal will appear only if the 'isVisible' property is true from the props passed to it.
// Clicking on the backdrop will dismiss it and the modal.

const backdrop = (props) => (
  props.isVisible ? <div className={classes.Backdrop} onClick={props.clicked}></div> : null
);
